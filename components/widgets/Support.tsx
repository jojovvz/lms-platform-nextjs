...
const Support = () => {
    return (
        <div className='w-full overflow-x-hidden flex justify-between px-[9vw]'>
            ...
            <div className='w-[200vw]  flex flex-col items-center gap-5'>
                <div className='flex flex-col items-center gap-2'>
                    <div className='text-[4rem] font-semibold text-center'>Help & Support</div>
                    <div className='text-center'>Our Help & Support team is here to assist you with any questions or issues you may encounter. Whether you need technical guidance, account assistance, or answers to general queries, we provide prompt and reliable support through email, chat, and a comprehensive knowledge base. Your satisfaction is our priority!</div>
                </div>
