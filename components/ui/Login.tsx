    ...
    const onSubmitForm = async (data: FieldValues) => {
        ...
        try {
            ...
            toast({
                ...
                description: "Something Went Wrong, It seems that user doesnot exists, Email Not Verified or Invalid credentials!",
                variant: "destructive",
            });
        } finally {
            setIsLoading(false);
            ...
            <div className='flex justify-center items-center md:w-[35vw] relative'>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Access your account by entering your registered email and password below. Stay connected and manage your activities with ease.
                        </CardDescription>
                    </CardHeader>
                    ...
                    <form onSubmit={handleSubmit(onSubmitForm)}>
                        ...
                        <CardFooter className='w-full flex flex-col items-center gap-2'>
                            ...
                            />
                            <div>
                                Don't have an account yet? <Link href="/register"><span className='font-semibold text-lightblue cursor-pointer'>Register</span></Link>
                            </div>
                        </CardFooter>
                    </form>
                </Card>
